...
EOF
      ...
      insert_rr_sites = <<EOF
				insert into rights_roles (right_id,role_id)values(1,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(2,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(5,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(5,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(6,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(9,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(10,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(11,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(12,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(13,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(14,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(15,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(16,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(17,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(18,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(19,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(20,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(21,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(22,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(23,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(24,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(25,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(26,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(27,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(28,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(29,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(30,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(31,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(32,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(33,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(34,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(35,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(36,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(37,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(38,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(39,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(40,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(41,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(42,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(43,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(44,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(45,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(46,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(47,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(48,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(49,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(50,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(51,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(52,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(53,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(54,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(56,#{id_gerente});
				insert into rights_roles (right_id,role_id)values(9,#{id_editor});
				insert into rights_roles (right_id,role_id)values(10,#{id_editor});
				insert into rights_roles (right_id,role_id)values(11,#{id_editor});
				insert into rights_roles (right_id,role_id)values(12,#{id_editor});
				insert into rights_roles (right_id,role_id)values(13,#{id_editor});
				insert into rights_roles (right_id,role_id)values(14,#{id_editor});
				insert into rights_roles (right_id,role_id)values(15,#{id_editor});
				insert into rights_roles (right_id,role_id)values(16,#{id_editor});
				insert into rights_roles (right_id,role_id)values(17,#{id_editor});
				insert into rights_roles (right_id,role_id)values(18,#{id_editor});
				insert into rights_roles (right_id,role_id)values(19,#{id_editor});
				insert into rights_roles (right_id,role_id)values(20,#{id_editor});
				insert into rights_roles (right_id,role_id)values(21,#{id_editor});
				insert into rights_roles (right_id,role_id)values(22,#{id_editor});
				insert into rights_roles (right_id,role_id)values(23,#{id_editor});
				insert into rights_roles (right_id,role_id)values(24,#{id_editor});
				insert into rights_roles (right_id,role_id)values(25,#{id_editor});
				insert into rights_roles (right_id,role_id)values(26,#{id_editor});
				insert into rights_roles (right_id,role_id)values(27,#{id_editor});
				insert into rights_roles (right_id,role_id)values(28,#{id_editor});
				insert into rights_roles (right_id,role_id)values(29,#{id_editor});
				insert into rights_roles (right_id,role_id)values(30,#{id_editor});
				insert into rights_roles (right_id,role_id)values(33,#{id_editor});
				insert into rights_roles (right_id,role_id)values(34,#{id_editor});
				insert into rights_roles (right_id,role_id)values(35,#{id_editor});
				insert into rights_roles (right_id,role_id)values(36,#{id_editor});
				insert into rights_roles (right_id,role_id)values(38,#{id_editor});
				insert into rights_roles (right_id,role_id)values(39,#{id_editor});
				insert into rights_roles (right_id,role_id)values(40,#{id_editor});
				insert into rights_roles (right_id,role_id)values(41,#{id_editor});
				insert into rights_roles (right_id,role_id)values(42,#{id_editor});
				insert into rights_roles (right_id,role_id)values(42,#{id_editor});
				insert into rights_roles (right_id,role_id)values(43,#{id_editor});
				insert into rights_roles (right_id,role_id)values(44,#{id_editor});
				insert into rights_roles (right_id,role_id)values(45,#{id_editor});
				insert into rights_roles (right_id,role_id)values(46,#{id_editor});
				insert into rights_roles (right_id,role_id)values(48,#{id_editor});
				insert into rights_roles (right_id,role_id)values(49,#{id_editor});
				insert into rights_roles (right_id,role_id)values(50,#{id_editor});
				insert into rights_roles (right_id,role_id)values(51,#{id_editor});
				insert into rights_roles (right_id,role_id)values(52,#{id_editor});
				insert into rights_roles (right_id,role_id)values(53,#{id_editor});
				insert into rights_roles (right_id,role_id)values(54,#{id_editor});
				insert into rights_roles (right_id,role_id)values(56,#{id_editor});
				insert into rights_roles (right_id,role_id)values(9,#{id_redator});
				insert into rights_roles (right_id,role_id)values(10,#{id_redator});
				insert into rights_roles (right_id,role_id)values(14,#{id_redator});
				insert into rights_roles (right_id,role_id)values(16,#{id_redator});
				insert into rights_roles (right_id,role_id)values(17,#{id_redator});
				insert into rights_roles (right_id,role_id)values(22,#{id_redator});
				insert into rights_roles (right_id,role_id)values(23,#{id_redator});
				insert into rights_roles (right_id,role_id)values(24,#{id_redator});
				insert into rights_roles (right_id,role_id)values(26,#{id_redator});
				insert into rights_roles (right_id,role_id)values(27,#{id_redator});
				insert into rights_roles (right_id,role_id)values(28,#{id_redator});
				insert into rights_roles (right_id,role_id)values(29,#{id_redator});
				insert into rights_roles (right_id,role_id)values(30,#{id_redator});
				insert into rights_roles (right_id,role_id)values(34,#{id_redator});
				insert into rights_roles (right_id,role_id)values(35,#{id_redator});
				insert into rights_roles (right_id,role_id)values(39,#{id_redator});
				insert into rights_roles (right_id,role_id)values(40,#{id_redator});
				insert into rights_roles (right_id,role_id)values(43,#{id_redator});
				insert into rights_roles (right_id,role_id)values(44,#{id_redator});
				insert into rights_roles (right_id,role_id)values(45,#{id_redator});
EOF
        ...
        if @convar["#{this_site['site_id']}"]["usuarios"]["#{this_user['id']}"].nil? and this_user['login_name'] != 'admin'
          ...
          puts "\t\tRELACIONANDO com seu devido cargo\n" if @verbose	
					...
					case this_user['grupo']
						when 'A'
							insert_roles_users = "INSERT INTO roles_users (role_id,user_id)VALUES(#{id_gerente},#{user[0]['id']})"
						when 'C'
							insert_roles_users = "INSERT INTO roles_users (role_id,user_id)VALUES(#{id_editor},#{user[0]['id']})"
						when 'R'
							insert_roles_users = "INSERT INTO roles_users (role_id,user_id)VALUES(#{id_redator},#{user[0]['id']})"
					end
