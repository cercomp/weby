class ImageComponent < Component
  component_settings :repository_id, :contrast_repository_id, :size, :height, :width, :target_type, :target_id, :url,
  					 :new_tab, :html_class, :default_image, :contrast_default_image, :title
