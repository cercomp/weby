...
$(document).ready(function() {
  ...
  tinymce.init({
    ...
    toolbar2: "forecolor backcolor | bullist numlist outdent indent | link unlink anchor image media template | removeformat | code codesample preview fullscreen",
    ...
    content_css: '/assets/weby-assets.css',
    templates: [
      {title: 'Card Equipe Horizontal', url: '/admin/pages/template/card_team_horizontal.html'},
      {title: 'Card Equipe Vertical', url: '/admin/pages/template/card_team_vertical_01.html'},
      {title: '2 Cards Equipe Vertical', url: '/admin/pages/template/card_team_vertical_02.html'},
      {title: '3 Cards Equipe Vertical', url: '/admin/pages/template/card_team_vertical_03.html'}
    ],
