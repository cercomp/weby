...
$(document).ready(function() {
  ...
  tinymce.init({
    ...
    content_css: '/assets/weby-assets.css',
     templates: [
       { title: 'Card Team Horizontal', url: '/admin/pages/template/card_team_horizontal.html'},
       { title: 'Card Team Vertical', url: '/admin/pages/template/card_team_vertical_01.html'},
       {title: '2 Cards Team Vertical', url: '/admin/pages/template/card_team_vertical_02.html'},
       {title: '3 Cards Team Vertical', url: '/admin/pages/template/card_team_vertical_03.html'}
     ],
