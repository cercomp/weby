...
$(function(){
   ...
   .bind('fileuploaddone', function (e, data) {
    ...
    .bind('fileuploadalways', function (e, data) {
          c = data;
          $("#upload-file-progress").val(null).hide();
...
function ajaxUpload(){
   ...
   $('#ajax-upload-form').fileupload('send', {
       ...
       dataType: "json",
       formData: [
       {name: "repository[description]", value: $("#dialog-repository-search #description").val()},
       {name: "repository[site_id]", value: $("#dialog-repository-search #site_id").val()},
    ]});
