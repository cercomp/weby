class Admin::SettingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @setting.save
        format.html { redirect_to(admin_settings_path, flash: {success: 'Setting was successfully created.'}) }
  ...
  def update
    ...
    respond_to do |format|
      if @setting.update_attributes(params[:setting])
        format.html { redirect_to(admin_settings_path, flash: {success: 'Setting was successfully updated.'}) }
        format.xml  { head :ok }
      else
