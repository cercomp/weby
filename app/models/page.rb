class Page < ActiveRecord::Base
  ...
  scope :clipping, proc { select("distinct on (site_id) pages.*").where("pages.updated_at >= ?", Time.now - Weby::Settings.clipping_per_days.to_i.days).order("site_id, pages.created_at desc") }
