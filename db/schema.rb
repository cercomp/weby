...
ActiveRecord::Schema.define(version: 20140912175208) do
  ...
  create_table "journal_event_i18ns", force: true do |t|
    t.integer  "journal_event_id"
    t.integer  "locale_id"
    t.string   "name"
    t.text     "information"
  ...
  add_index "journal_event_i18ns", ["journal_event_id"], name: "index_journal_event_i18ns_on_journal_event_id", using: :btree
  add_index "journal_event_i18ns", ["locale_id"], name: "index_journal_event_i18ns_on_locale_id", using: :btree

  create_table "journal_events", force: true do |t|
    t.integer  "site_id"
  ...
  add_index "journal_events", ["repository_id"], name: "index_journal_events_on_repository_id", using: :btree
  add_index "journal_events", ["site_id"], name: "index_journal_events_on_site_id", using: :btree
  add_index "journal_events", ["user_id"], name: "index_journal_events_on_user_id", using: :btree
  ...
  add_index "journal_news", ["journal_event_id"], name: "index_journal_news_on_journal_event_id", using: :btree
  ...
  add_foreign_key "journal_event_i18ns", "journal_events", name: "journal_event_i18ns_journal_event_id_fk"
  add_foreign_key "journal_event_i18ns", "locales", name: "journal_event_i18ns_locale_id_fk"

  add_foreign_key "journal_events", "repositories", name: "journal_events_repository_id_fk"
  add_foreign_key "journal_events", "sites", name: "journal_events_site_id_fk"
  add_foreign_key "journal_events", "users", name: "journal_events_user_id_fk"

  add_foreign_key "journal_news", "journal_events", name: "journal_news_journal_event_id_fk"
  add_foreign_key "journal_news", "repositories", name: "journal_news_repository_id_fk"
  add_foreign_key "journal_news", "sites", name: "journal_news_site_id_fk"
  add_foreign_key "journal_news", "users", name: "journal_news_user_id_fk"

  add_foreign_key "journal_news_i18ns", "journal_news", name: "journal_news_i18ns_journal_news_id_fk"
  add_foreign_key "journal_news_i18ns", "locales", name: "journal_news_i18ns_locale_id_fk"
  ...
  add_foreign_key "posts_repositories", "pages", name: "pages_repositories_page_id_fk", column: "post_id"
