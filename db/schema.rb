...
ActiveRecord::Schema.define(version: 2024_12_03_181860) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "acadufg_settings", id: :serial, force: :cascade do |t|
    t.integer "site_id"
    t.integer "programa_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["site_id"], name: "index_acadufg_settings_on_site_id"
  end
  ...
  create_table "calendar_event_i18ns", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean "sync_with_parent", default: true
  ...
  create_table "calendar_events", id: :serial, force: :cascade do |t|
    ...
    t.text "sync_fields", default: ""
    t.index ["parent_event_id"], name: "index_calendar_events_on_parent_event_id"
    t.index ["repository_id"], name: "index_calendar_events_on_repository_id"
    t.index ["shared"], name: "index_calendar_events_on_shared"
  ...
  add_foreign_key "calendar_events", "calendar_events", column: "parent_event_id", on_delete: :cascade
