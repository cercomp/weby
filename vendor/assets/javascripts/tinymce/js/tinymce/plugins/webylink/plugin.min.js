...
tinymce.PluginManager.add('webylink', function(editor) {
			...
			body: [
                {
                  ...
                  html: '<ul class="nav nav-tabs">'+
                          '<li class="active"><a href="#page_list" data-toggle="tab">Páginas</a></li>'+
                          '<li><a href="#repo_list" data-toggle="tab">Arquivos</a></li>'+
                        '</ul>'+
                        '<div class="tab-content link-search" style="height: 235px">'+
                          '<div class="tab-pane active" id="page_list"><img src="/assets/loading.gif" alt=""/></div>'+
                          '<div class="tab-pane" id="repo_list"></div>'+
                         '</div>'
                },
                {
					name: 'href',
